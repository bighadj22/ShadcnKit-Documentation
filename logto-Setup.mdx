...
<img src="/images/shadcnkit-logto-account.gif" alt="Logto Setup for ShadcnKit" />
...
2. Create a new user or select an existing user to be the admin.
3. Note down the user ID of this admin user.
